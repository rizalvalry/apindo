        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                <a href="{{route('user.home')}}">
                    <b class="logo-icon">
                        <img src="{{ getFile(config('basic.default_file_driver'),config('basic.logo_image')) }}" alt="@lang('homepage')" class="dark-logo">
                        <img src="{{ getFile(config('basic.default_file_driver'),config('basic.logo_image')) }}" alt="@lang('homepage')" class="light-logo">
                    </b>
                </a>
            </div>
