                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="inbox-wrapper">
                                            ...
                                            <div>
                                                @if($singleProductQuery->get_listing->get_user->id == Auth::id())
                                                    ...
                                                    <div class="massenger_active">
                                                        <img class="user img-fluid" src="{{getFile(optional($singleProductQuery->get_client)->driver, optional($singleProductQuery->get_client)->image)}}" alt="{{config('basic.site_title')}}"/>
                                                ...
                                                @else
                                                    <div class="massenger_active">
                                                        <img class="user img-fluid" src="{{getFile(optional($singleProductQuery->get_user)->driver, optional($singleProductQuery->get_user)->image)}}"/>
                                        ...
                                        <div class="typing-area">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea v-model="message" @keydown.enter.prevent="sendMessage" @keydown="onTyping" cols="30" rows="10" class="form-control type-message" placeholder="@lang('Type your message...')"></textarea>
                                ...
                                <div class="col-lg-5">
                                    <div class="row">
                                                        ...
                                                        <div class="inbox_right_side bg-white rounded">
                                                            ...
                                                            <div class="inbox_right_side__profile  p-3">
                                                                <div
                                                                    ...
                                                                    <img src="{{ getFile(optional($singleProductQuery->get_product)->driver, optional($singleProductQuery->get_product)->product_thumbnail) }}" class="productInfoThumbnail">
                                                                </div>
                                                                ...
                                                                <div class="inbox_right_side__profile__info">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p>@if(optional($singleProductQuery->get_product)->product_price)
                                                                                {{$basic->currency_symbol}} {{ optional($singleProductQuery->get_product)->product_price }}
                                                                            @else
                                                                                @lang('N/A')
                                                                            @endif
                                                                        </p>
                                        ...
                                        <div class="col-lg-12">
                                            @if($singleProductQuery->get_listing->user_id == Auth::id())
                                                <div class="search-bar my-search-bar">
                                                    <form action="" method="get" enctype="multipart/form-data">
                                                        <div class="row g-3">
                                                            <div class="d-flex justify-content-center">
                                                            ...
                                                            <div class="inbox_right_side bg-white rounded m-0">
                                                                <div class="inbox_right_side__profile  p-3">
                                                                    <div class="inbox_right_side__profile__header text-center mb-4">
                                                                        <img src="{{ getFile(optional($singleProductQuery->get_client)->driver, optional($singleProductQuery->get_client)->image) }}" class="productClientImage">
                                                                        <h6 class="mt-2 mb-0">
                                                                    ...
                                                                    <div class="inbox_right_side__profile__info">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p>
                                                                                @if(optional($singleProductQuery->get_client)->website)
                                                                                    <a href="{{ optional($singleProductQuery->get_client)->website }}" target="_blank">
                                                                        ...
                                                                        <div
                                                                            class="inbox_right_side__profile__info__phone d-flex justify-content-between">
                                                                            <p>{{ __('Address') }}:</p>
                                                                            <p>@if(optional($singleProductQuery->get_client)->address)
                                                                                    {{ optional($singleProductQuery->get_client)->address }}
                                                                                @else
                                                                                    @lang('N/A')
                                                                                @endif</p>
                                                                        </div>
                                                                ...
                                                                <div class="right_side_bottom p-3">
                                                                    <a href="{{ route('profile', [@slug($singleProductQuery->get_client->firstname), $singleProductQuery->get_client->id]) }}" target="_blank" class="btn btn-primary btn-custom__product__reply d-flex justify-content-center">@lang('Visit Profile')</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="inbox_right_side bg-white rounded m-0">
                                                                ...
                                                                <div class="inbox_right_side__profile  p-3">
                                                                    <div
                                                                        class="inbox_right_side__profile__header text-center mb-4">
                                                                        <img src="{{ getFile(optional(optional($singleProductQuery->get_listing)->get_user)->driver, optional(optional($singleProductQuery->get_listing)->get_user)->image) }}" class="productClientImage">
                                                                        <h6 class="mt-2 mb-0">
                                                                    ...
                                                                    <div class="inbox_right_side__profile__info">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p>{{ __('Address') }}:</p>
                                                                            <p>
                                                                                @if(optional(optional($singleProductQuery->get_listing)->get_user)->address)
        ...
        let messenger = new Vue({
            ...
            methods: {
                ...
                allMessages() {
                    ...
                    axios.post("{{ route('user.productReplyMessageRender') }}", this.item)
                        .then(response => {
                ...
                sendMessage() {
                    ...
                    axios.post("{{route('user.productReplyMessage')}}", formData, {headers})
                        .then(function (res) {
                            _this.message = '';
                            _this.file = '';
