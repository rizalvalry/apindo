                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        <div class="card-body  profile-setting">
                            <div class="row ">
                                <div class="col-md-12">
                                    <h5 class=" text-center">{{trans('Please follow the instruction below')}}</h5>
                                    <p class="text-center mt-2 ">{{trans('You have requested to deposit')}}  <strong>{{getAmount($order->amount)}}
                                            {{$basic->currency}}</strong> , {{trans('Please pay')}}
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="fileinput fileinput-new " data-provides="fileinput">
                                                                ...
                                                                <div class="fileinput-preview fileinput-exists thumbnail wh-200-150" width="200"></div>
