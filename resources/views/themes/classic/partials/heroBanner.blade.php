                                    ...
                                    <div class="input-box col-lg-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select class="listing__category__select2 form-control" name="category[]">
                                                <option value="all" @if(request()->category && in_array('all',
                                                    request()->category))
                                                    selected
                                    ...
                                    <div class="input-box col-lg-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select class="js-example-basic-single form-control" name="location"
                                                autocomplete="off">
                                                <option value="all" @if(request()->location == 'all') selected
                                                    @endif>@lang('All Locations')</option>
                                                @foreach($all_places as $place)
                                                <option value="{{ $place->id }}" @if(request()->location == $place->id)
                                                    selected @endif>@lang(optional($place->details)->place)</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
