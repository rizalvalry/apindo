            ...
            <div class="navbar-upper__wrapper">
                <div class="navbar-upper__logo">
                    <a href="index.html" class="navbar-upper__image-container">
                        <img src="{{ getFile(config('basic.default_file_driver'),config('basic.logo_image')) }}" class="navbar-upper__image" alt="{{config('basic.site_title')}}">
                    </a>
                    ...
                    <div class="dropdown d-inline-flex">
                        ...
                        <div class="d-flex align-items-center">
                            <a class="dropdown-toggle navbar-upper__button-language" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{asset('assets/admin/images/id.png')}}" class="navbar-upper__language-icon" alt="language icon">
                                <span>ID</span>
                            </a>
    ...
    <nav class="navbar navbar-expand-lg bsnav" id="navbar">
        <div class="container-fluid">
            <button type="button" class="navbar__button-search-mobile">
                <img src="{{asset('assets/admin/images/search-icon.svg')}}" class="navbar-upper__language-icon navbar__button navbar__icon-search-mobile" alt="search icon">
                <span>SEARCH</span>
            </button>
