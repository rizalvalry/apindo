        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    @forelse($listingCategory as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge badge-pill badge-danger">@lang('Deactive')</span>
                                @endif
                            ...
                            @if(adminAccessRoute(config('role.manage_listing.access.edit')) == true || adminAccessRoute(config('role.manage_listing.access.delete')) == true)
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="{{ route('admin.listingCategoryEdit',$item->id) }}" class="btn btn-sm btn-outline-primary rounded btn-icon edit_button">
                    ...
                    @empty
                        <tr>
                            <td colspan="100%" class="text-danger text-center">@lang('No Data Found')</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
