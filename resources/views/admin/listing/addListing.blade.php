         ...
         <div class="main row gy-4">
               ...
               <div class="form">
                  <div class="basic-form p-4">
                     <div class="row g-3">
                        ...
                        <div class="input-box col-md-6">
                        <input class="form-control @error('replies_text.0') is-invalid @enderror"
                           type="text" name="replies_text" placeholder="@lang('Sub Kategori')"
                           value="{{ old('replies_text.0') }}"/>
                        @error('replies_text.0')
                        ...
                        <div class="form">
                           <div class="row g-3 location-form">
                              ...
                              <div class="input-box col-md-12">
                                 <textarea type="text" name="rejected_reason" value="{{ old('rejected_reason') }}"
            ...
            <div class="col-xl-8">
               ...
               <div class="form business-hour">
                  <div class="d-sm-flex justify-content-between delete_this @error('working_day') is-invalid @enderror">
                     <div class="input-box w-100 my-1 me-1">
                        <input type="text" name="working_day" value="{{ old('working_day') }}"
                           class="form-control @error('working_day') is-invalid @enderror"
                           placeholder="@lang('KODE')"/>
                        <div class="invalid-feedback">
                           @error('working_day') @lang($message) @enderror
                        </div>
                        
                        <div class="d-flex">
                            <div class="input-box w-100 my-1 me-1">
                                <input type="text" name="start_time" value="{{ old('start_time.0') }}"
                                    class="form-control datepicker position-datepicker @error('start_time.0') is-invalid @enderror"
                            ...
                            <div class="input-box w-100 my-1 me-1">
                                <input type="text" name="end_time" value="{{ old('end_time.0') }}"
                                    class="form-control datepicker position-datepicker @error('end_time.0') is-invalid @enderror"
                        ...
                        <div class="d-flex">
                            <div class="input-box col-md-12 bg-white p-0">
                                <textarea class="form-control @error('body_text.0') is-invalid @enderror" name="body_text">{{ old('body_text.0') }}</textarea>
                                <div class="invalid-feedback">
                                    @error('body_text.0') @lang($message) @enderror
                                </div>
                            </div>
                        </div>
