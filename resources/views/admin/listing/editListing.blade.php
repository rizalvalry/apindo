                ...
                <div class="switcher navigator">
                    ...
                    @if($single_package_infos->is_whatsapp == 1 || $single_package_infos->is_messenger == 1)
                        <button tab-id="tab7" class="tab">
                            @lang('Communication')
                            @if ($errors->has('whatsapp_number') || $errors->has('messenger_app_id') || $errors->has('messenger_page_id'))
                                @php
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="input-box w-100 my-1 me-1">
                                                            <input type="time" name="start_time[]" value="{{ old("start_time.$i", $business_hours[$i]->start_time ?? '') }}" class="form-control @error("start_time.$i") is-invalid @enderror" placeholder="@lang('Start Hour')"/>
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="input-box w-100 my-1 me-1">
                                                            <input type="time" name="end_time[]"
                                                                   ...
                                                                   class="form-control h-100 @error("end_time.$i") is-invalid @enderror"
                        ...
                        <div class="main row gy-4">
                            ...
                            @if($single_package_infos->is_image == 1)
                                <div class="col-xl-7 custom-margin">
                                    <h3 class="mb-3 listing-tab-heading">@lang('Images')</h3>
                                    ...
                                    <span
                                        class="text-danger"> @error('listing_image.*') @lang($message) @enderror</span>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    @if($single_package_infos->is_product == 1)
                        <div id="tab5" class="add-listing-form content">
                            <div class="d-flex justify-content-start">
                                <h3 class="me-3 mr-3">@lang('Product')</h3>
                                <button class="btn-custom-product add-new-product" type="button" id="add_products"
                                    ...
                                    <i class="fa fa-plus"></i> @lang('Add More') (<span class="product_count">
                                                    ...
                                                    <div class="upload-img thumbnail">
                                                        <div class="form">
                                                            <div class="img-box product-thumbnail">
                                                                ...
                                                                <span
                                                                    class="select-file">@lang('Product Thumbnail')</span>
                    ...
                    @if($single_package_infos->seo == 1)
                        <div id="tab6" class="add-listing-form content">
                            <div class="main row gy-4">
                                ...
                                <div class="col-xl-6">
                                    <h3 class="mb-3 listing-tab-heading">@lang('SEO & META Keywords')</h3>
                                    <div class="form">
                                        <div class="row g-3">
                                            <div class="input-box col-md-12">
                                                <input class="form-control social-admin-listing-edit mb-2" type="text"
                                                       name="meta_title" placeholder="@lang('title')"
                                                       value="{{ @$listing_seo->meta_title }}"/>
                                            </div>

                                            <div class="input-box col-md-12">
                                                <input
                                                    class="form-control mb-1 tags_input social-admin-listing-edit mb-3"
                                                    type="text" placeholder="@lang('keywords')" name="meta_keywords"
                                                    value="{{ @$listing_seo->meta_keywords }}" data-role="tagsinput"/>
                                            </div>

                                            <div class="input-box col-12">
                                                <textarea class="form-control seo__desc" cols="30" rows="3"
                                                          name="meta_description"
                                                          placeholder="@lang('description')">{{ @$listing_seo->meta_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form">
                                            <div class="basic-form p-4">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="input-box col-md-12">
                                                        <textarea class="form-control summernote @error('body_text') is-invalid @enderror" name="body_text" id="summernote" rows="15" value="{{ old('body_text', $single_listing_infos->body_text ) }}">{{ old('body_text', $single_listing_infos->body_text) }}</textarea>
            ...
            $(document).ready(function () {
                ...
                $("#add_business_hour").on('click', function () {
                    var form = `<div class="d-sm-flex justify-content-between removeBusinessHourInputField">
                        ...
                        <div class="d-flex input-box-two">
                            <div class="input-box w-100 my-1 me-1">
                                <input type="time" name="start_time[]" class="form-control h-100" placeholder="@lang('Start Hour')" />
                            </div>
                            <div class="input-box w-100 my-1 me-1">
                                <input type="time" name="end_time[]" class="form-control h-100" placeholder="@lang('End Hour')" />
                            </div>
                            <div class="input-box my-1 me-1">
                ...
                $("#add_social_links").on('click', function () {
                    ...
                    var form = `<div class="d-flex justify-content-between append_new_social_form removeSocialLinksInput">
                        ...
                        <div class="input-box w-100 my-1 me-1">
                            <input type="url" name="social_url[]" class="form-control h-100" placeholder="@lang('URL')"/>
                        </div>
                        <div class="my-1 me-1">
