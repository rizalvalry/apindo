                                            ...
                                            <div class="modal-content ">
                                                ...
                                                <form role="form" method="POST" class="actionRoute" action="{{route('admin.updateStaff',$data)}}" enctype="multipart/form-data" >
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control " name="email"
                                                                       placeholder="@lang('Email Address')" value="{{$data->email}}" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="password" name="password" placeholder="@lang('Password')" autocomplete="off"
                                                                       class="form-control" >
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                    ...
                                                                    <div class="card-body select-all-access">
                                                                        ...
                                                                        <table class=" table table-hover table-striped table-bordered text-center">
                                                                            ...
                                                                            @foreach(config('role') as $key => $value)
                                                                                <tr>
                                                                                    <td data-label="" class="text-left"> {{$value['label']}} </td>
                                                                                    <td data-label="View">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-outline-secondary btn-sm rounded" data-dismiss="modal">@lang('Close')</button>
                                                        <button type="submit" class="btn btn-outline-success btn-sm rounded" >@lang('Update')</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
