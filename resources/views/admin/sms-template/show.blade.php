            ...
            <div class="table-responsive">
                <table id="zero_config" class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        @if(adminAccessRoute(config('role.website_controls.access.edit')))
                        <td>
                            <a  href="{{ route('admin.sms-template.edit',$template->id) }}" class="btn btn-sm btn-outline-primary rounded" title="@lang('Edit')"><i class="fas fa-edit" aria-hidden="true"></i></a>
                        </td>
                        @endif
                    </tr>
                    @endforeach
