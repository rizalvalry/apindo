            ...
            <div class="tab-content mt-2" id="myTabContent">
                @foreach($languages as $key => $language)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
                         role="tabpanel">
                        <form method="post" action="{{ route('admin.packageStore', $language->id) }}" class="mt-4"
                                ...
                                @if ($loop->index == 0)
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text package_price_symbol border-right-1"
                                                      id="basic-addon2"> {{ $basic->currency_symbol ?? '$' }} </span>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12 d-none is_multiple_time_purchase">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name="is_multiple_time_purchase" {{ old('is_multiple_time_purchase') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_multiple_time_purchase" id="is_multiple_time_purchase" class="custom-switch-checkbox" value="0" {{ old('is_multiple_time_purchase') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 mb-3 package_expiry">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <span class="input-group-text" id="basic-addon2"> <span
                                                        class="mr-2">@lang('Unlimited')</span>
                            ...
                            @if ($loop->index == 0)
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name="is_image" {{ old('is_image') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_image" id="is_image" class="custom-switch-checkbox image_no" value="0" {{ old('is_image') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name="is_video" {{ old('is_video') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_video" id="is_video" class="custom-switch-checkbox video_no" value="0" {{ old('is_video') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name="is_amenities" {{ old('is_amenities') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_amenities" id="is_amenities" class="custom-switch-checkbox amenities_no" value="0" {{ old('is_amenities') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name="is_product" {{ old('is_product') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_product" id="is_product" class="custom-switch-checkbox product_no" value="0" {{ old('is_product') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name='is_business_hour' {{ old('is_business_hour') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_business_hour" id="is_business_hour" class="custom-switch-checkbox" value="0" {{ old('is_business_hour') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name='seo' {{ old('seo') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="seo" class="custom-switch-checkbox"
                                                    id="seo"
                                                    value="0" {{ old('seo') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        <label>@lang('Messenger Chat SDK')</label>
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name='is_messenger' {{ old('is_messenger') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_messenger" class="custom-switch-checkbox"
                                                   id="is_messenger"
                                                   value="0" {{ old('is_messenger') == "0" ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6">
                                        <label>@lang('Whatsapp Chat SDK')</label>
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name='is_whatsapp' {{ old('is_whatsapp') == "1" ? 'checked' : '' }}>
                                            <input type="checkbox" name="is_whatsapp" class="custom-switch-checkbox"
                                                   id="is_whatsapp"
                                                   value="0" {{ old('is_whatsapp') == "0" ? 'checked' : '' }}>
                            ...
                            @if ($loop->index == 0)
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" name="no_of_categories_per_listing"
                                                   value="{{ old('no_of_categories_per_listing') }}" min="1"
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" name="no_of_amenities_per_listing"
                                                   value="{{ old('no_of_amenities_per_listing') }}" min="1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" name="no_of_img_per_product"
                                                   value="{{ old('no_of_img_per_product') }}" min="1"
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name='is_renew' {{ old('is_renew') == "1" ? 'checked' : '' }} class="is_renew">
                                            <input type="checkbox" name="is_renew" class="custom-switch-checkbox is_renew"
                                                   id="is_renew"
                                                   value="0" {{ old('is_renew') == "0" ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="image-input ">
                                                ...
                                                <input type="file" name="image" placeholder="@lang('Choose image')"
                                                       id="image" @error('image') is-invalid @enderror>
