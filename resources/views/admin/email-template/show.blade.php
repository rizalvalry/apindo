                ...
                <table id="zero_config"
                    ...
                    @foreach($emailTemplate as $template)
                        <tr>
                            ...
                            @if(adminAccessRoute(config('role.website_controls.access.edit')))
                            <td>
                                <a  href="{{ route('admin.email-template.edit',$template->id) }}" class="btn btn-sm btn-outline-primary rounded" title="@lang('Edit')"><i class="fas fa-edit" aria-hidden="true"></i></a>
                            </td>
                            @endif
                        </tr>
                    @endforeach
