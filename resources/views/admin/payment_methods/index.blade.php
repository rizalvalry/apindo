...
@section('content')
    ...
    <div class="container-fluid">
        <div class="bd-callout bd-callout-warning">
            <i class="fas fa-info-circle mr-2"></i> @lang('Pull up or down the rows to sort the ranking list order that how do you want to display the ranking in admin and user panel.') </div>
                                            ...
                                            <a href="{{ route('admin.edit.payment.methods', $method->id) }}"
                                               ...
                                               data-original-title="@lang('Edit this Payment Methods info')">
                                                ...
                                                <button type="button"
                                                        ...
                                                        class="btn btn-sm btn-outline-{{($method->status == 0)?'success':'danger'}}   rounded disableBtn"
