            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                                ...
                                @if($ticket->user_id)
                                    <div class="float-left">
                                        <a href="{{ route('admin.user-edit', $ticket->user_id)}}" target="_blank">
                                            <img src="{{ getFile(optional($ticket->user)->driver, optional($ticket->user)->image) }}" alt="{{config('basic.site_title')}}" class="contactImageUser">
                                        </a>
                                    </div>
                                    <div class="float-left">
                                        @lang(optional($ticket->user)->fullname) <br>
                                        @lang(optional($ticket->user)->email)
                                    </div>
                                @else
                                    <p class="font-weight-bold"> @lang($ticket->name)</p>
                                @endif
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="100%">
                                <p class="text-danger text-center">@lang($empty_message)</p>
                            </td>
                        </tr>
