...
@section('content')
    <div class="container-fluid">
        <div class="bd-callout bd-callout-warning">
            <i class="fas fa-info-circle mr-2"></i> @lang('After changes image. Please clear your browser\'s cache to see changes.') </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-input">
                                            ...
                                            <img id="image_preview_container" class="preview-image"
                                                 src="{{ getFile(config('basic.default_file_driver'),config('basic.admin_banner')) ? : 0 }}"
