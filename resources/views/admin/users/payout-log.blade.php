                    ...
                    @forelse($records as $key => $item)
                        <tr>
                            ...
                            <td data-label="@lang('Detail')">
                                ...
                                @endphp
                                <button type="button" class="btn btn-outline-primary rounded btn-sm btn-icon edit_button"
            ...
            $(document).ready(function () {
                $(document).on("click", '.edit_button', function (e) {
                    ...
                    details.map(function (item, i) {
                        if (item[1].type == 'file') {
                            var singleInfo = `<br><img src="${ImgPath}/${item[1].field_name}" alt="@lang('...')" class="w-100">`;
                        } else {
