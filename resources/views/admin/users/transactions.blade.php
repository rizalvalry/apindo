            ...
            <table class="categories-show-table table table-hover table-striped table-bordered">
                ...
                @forelse($transaction as $k => $row)
                    <tr>
                        ...
                        <td data-label="@lang('Amountddd')"> <span class="text-{{($row->trx_type == "+") ? 'success' :'danger'}}">{{config('basic.currency_symbol')}}{{getAmount($row->amount, config('basic.fraction_number'))}}</span></td>
