                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="image-input ">
                                                        ...
                                                        <img id="image_preview_container" class="preview-image"
                                                             src="{{ getFile(@$contentMedia->driver,(isset($contentMedia->description->{$name}) ? @$contentMedia->description->{$name} : '')) }}"
                                            ...
                                            <div class="row">
                                                @foreach(config("contents.$content->name.field_name") as $name => $type)
                                                    ...
                                                    @elseif($type == 'icon' && $key ==0 )
                                                        ...
                                                        <button type="submit"
                                                                class="btn btn-primary btn-sm btn-block">@lang('Save Change')
                                                        </button>
                                        </form>
                                    </div>
                                @endforeach
