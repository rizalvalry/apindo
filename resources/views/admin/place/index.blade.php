            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        @if(adminAccessRoute(config('role.place.access.edit')) == true || adminAccessRoute(config('role.place.access.delete')) == true)
                                ...
                                @if(adminAccessRoute(config('role.place.access.edit')) == true || adminAccessRoute(config('role.place.access.delete')) == true)
                                    <td data-label="@lang('Action')">
                                        @if(adminAccessRoute(config('role.place.access.edit')) == true)
                                            <a href="{{ route('admin.placeEdit',$item->id) }}" class="btn btn-outline-primary btn-sm rounded btn-icon edit_button">
