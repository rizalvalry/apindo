        ...
        <div class="card-body">
            @if(adminAccessRoute(config('role.amenities.access.add')))
                <div class="media mb-4 float-right">
                    <a href="{{route('admin.amenitiesCreate')}}" class="btn btn-sm btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        @if(adminAccessRoute(config('role.amenities.access.edit')) == true || adminAccessRoute(config('role.amenities.access.delete')) == true)
                            ...
                            <tr>
                                ...
                                @if(adminAccessRoute(config('role.amenities.access.edit')) == true || adminAccessRoute(config('role.amenities.access.delete')) == true)
                                    <td data-label="@lang('Action')">
                                        @if(adminAccessRoute(config('role.amenities.access.edit')) == true)
                                            <a href="{{ route('admin.amenitiesEdit',$item->id) }}" class="btn btn-sm btn-outline-primary rounded edit-button">
