                                    ...
                                    <div class="col-sm-12 col-md-12 mb-3">
                                        ...
                                        <select name="blog_category_id" class="form-control @error('blog_category_id'.'.'.$language->id) is-invalid @enderror">
                                            @forelse ($blogCategory as $item)
                                                <option value="{{ optional($item->details)->blog_category_id }}" {{ optional($item->details)->blog_category_id == $blogDetails[$language->id][0]->blog->blog_category_id ? 'selected' : '' }}>@lang(optional($item->details)->name)</option>
                                            @empty
                                            @endforelse
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 my-3">
                                    <div class="form-group ">
                                        <label for="details"> @lang('Detailsffff') </label>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="image-input ">
                                                ...
                                                src="{{getFile(optional($blogDetails[$language->id][0]->blog)->driver, optional($blogDetails[$language->id][0]->blog)->image)}}"
