    ...
    <body>
        <div class="main-wrapper">
            ...
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
                 style="background:url({{ getFile(config('basic.default_file_driver'),config('basic.admin_login_bg')) }}) no-repeat center center;">
                <div class="auth-box row">
                    <div class="col-lg-6 col-md-5 modal-bg-img"
                         style="background-image: url({{ getFile(config('basic.default_file_driver'),config('basic.admin_login_theme')) }});">
                    </div>
