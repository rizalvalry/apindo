            ...
            <div class="navbar-brand">
                <a href="{{url('/')}}">
                    <span class="logo-text">
                        <img src="{{ getFile(config('basic.default_file_driver'),config('basic.admin_logo')) }}" alt="@lang('homepage')"
                             class="dark-logo"/>
                        <img src="{{ getFile(config('basic.default_file_driver'),config('basic.admin_logo')) }}" class="light-logo"
                             alt="@lang('homepage')"/>
                    </span>
                </a>
            </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        <img src="{{ getFile(Auth::guard('admin')->user()->driver,Auth::guard('admin')->user()->image) }}"
                             alt="@lang('user')"
