    ...
    public function smsConfig(Request $request)
    {
        if ($request->isMethod('GET')) {
            ...
            $validator = Validator::make($purifiedData, [
                ...
                'min' => __('Field value must be at least :min characters.'),
                'string' => __('Field value must be :string.'),
                'required_with' => __('Field value empty not allowed'),
            ]);
            ...
            return back()->with('success', __('SMS configuration Saved'));
        }
    }
