...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('flag') && $request->file('flag')->isValid()) {
            ...
            $image = $this->fileUpload($request->flag, config('location.language.path'), $language->driver, $flagName);
            if ($image) {
        ...
        $path = resource_path('lang/') . $json_file;
        File::put($path, $data);
        return redirect()->route('admin.language.index')->with('success', __('Language Successfully Saved'));
    }
    ...
    public function update(Request $request, language $language)
    {
        ...
        return back()->with('success', __('Language Successfully Saved'));
    }

    public function delete(language $language)
    {
        $this->fileDelete($language->driver, $language->flag);
        ...
        return back()->with('success', __('Language Has been Deleted'));
    }
