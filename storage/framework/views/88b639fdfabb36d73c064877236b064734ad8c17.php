...
<style>
.home-section {
    background: url(<?php echo e(getFile(optional($banner_heading->media)->driver,
                                    ...
                                    <div class="input-box col-lg-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name"
                                                <?php echo e(old('name', request()->name)); ?>class="form-control"
                                    ...
                                    <div class="input-box col-lg-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select class="listing__category__select2 form-control" name="category[]">
                                                <option value="all" <?php if(request()->category && in_array('all',
                                                    request()->category)): ?>
                                                    selected
                                                ...
                                                <option value="<?php echo e($category->id); ?>" <?php if(request()->category &&
                                    ...
                                    <div class="input-box col-lg-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select class="js-example-basic-single form-control" name="location"
                                                autocomplete="off">
                                                <option value="all" <?php if(request()->location == 'all'): ?> selected
                                                    <?php endif; ?>><?php echo app('translator')->get('All Locations'); ?></option>
                                                ...
                                                <option value="<?php echo e($place->id); ?>" <?php if(request()->location == $place->id): ?>
                                                    selected <?php endif; ?>><?php echo app('translator')->get(optional($place->details)->place); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\apindo\resources\views/themes/classic/partials/heroBanner.blade.php ENDPATH**/ ?>