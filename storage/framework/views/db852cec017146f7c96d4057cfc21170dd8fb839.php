                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input ">
                                                    ...
                                                    <img id="meta_image_preview_container" class="preview-image"
                                                         src="<?php echo e(getFile(config('basic.default_file_driver'),config('seo.meta_image')) ? : 0); ?>"
                                                         alt="preview image">
                                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\apindo\resources\views/admin/logo.blade.php ENDPATH**/ ?>